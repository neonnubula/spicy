      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="pulse-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Why Choose Most Important Thing</span>
          </div>
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Focus on What Truly Matters
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Transform your life with simple, powerful features designed to help you achieve your most important daily goals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Daily Focus"
            description="Set one most important goal each day and focus all your energy on achieving it."
            index={0}
          />
          <FeatureCard
            ...
            description="Visual progress indicators and streaks to keep you motivated and accountable."
            index={1}
          />
          <FeatureCard
            ...
            description="Gentle notifications that help you stay on track without overwhelming you."
            index={2}
          />
          <FeatureCard
            ...
            description="Build lasting habits by consistently achieving your most important daily goals."
            index={3}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            title="Free Forever"
            description="No subscriptions, no hidden fees. Transform your life completely free of charge."
            index={5}
          />
        </div>
      </div>
