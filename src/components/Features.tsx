      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Academic Arsenal, <br className="hidden sm:block" />AI-Powered Excellence
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with cutting-edge technology to understand, learn, and adapt to your academic needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Coaching"
            description="Personalized guidance to improve your writing skills and build confidence in academic work."
            index={0}
          />
          <FeatureCard
            ...
            title="Feedback"
            description="Detailed, constructive feedback that helps you refine your drafts and learn from mistakes."
            index={1}
          />
          <FeatureCard
            ...
            title="Structure"
            description="Smart outlining tools to organize your thoughts and create well-structured papers efficiently."
            index={2}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="7.5 4.21 12 6.81 16.5 4.21"></polyline><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" x2="12" y1="22.08" y2="12"></line></svg>}
            title="Generate Draft"
            description="AI-assisted drafting that generates starting points while encouraging your own input and revisions."
            index={3}
          />
          <FeatureCard
            ...
            title="Research"
            description="Efficient research assistance that finds reliable sources and helps integrate them properly."
            index={4}
          />
          <FeatureCard
            ...
            description="Built-in checks to ensure your work maintains honesty and avoids plagiarism risks."
            index={5}
          />
        </div>
      </div>
