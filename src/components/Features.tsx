...
const Features = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-dark-900" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="pulse-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Your complete academic arsenal</span>
          </div>
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Tools that build skills, not shortcuts
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Context retention across research, writing, and citations while keeping integrity at the center of your work.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Structure, outline, and draft faster with guidance that keeps your voice and meets academic standards."
            index={0}
          />
          <FeatureCard
            ...
            description="Transparent prompts and steps. Guidance that keeps you within your institution’s integrity policies."
            index={1}
          />
          <FeatureCard
            ...
            description="Collect sources, summarize responsibly, and extract key points with citations you can trust."
            index={2}
          />
          <FeatureCard
            ...
            description="Feed prompts your course context so outputs follow your rubric and instructor expectations."
            index={3}
          />
          <FeatureCard
            ...
            description="APA/MLA/Chicago in seconds with source metadata preserved for audits and review."
            index={4}
          />
          <FeatureCard
            ...
            title="Writing Coach"
            description="Improve clarity, tone, and argumentation with revision suggestions you can accept or reject."
            index={5}
          />
        </div>
      </div>
