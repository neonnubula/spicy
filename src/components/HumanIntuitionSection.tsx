      ...
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            ...
            <h2 className="section-title mb-6">Headline that does X</h2>
            <p className="text-lg text-gray-700 mb-6">
              Subheadline that does X
            </p>
            <ul className="space-y-4">
              {[
                "Feature benefit placeholder one",
                "Feature benefit placeholder two",
                "Feature benefit placeholder three",
                "Feature benefit placeholder four"
              ].map((item, index) => (
